...
@interface NetworkLinkSource (Private)

- (void) checkDataThread;

@end

@implementation NetworkLinkSource

registerSourceType(NetworkLinkSource)
...
- (void) registerCallback {
	...
	m_store = SCDynamicStoreCreate(NULL, CFSTR("ControlPlane"), linkChange, &ctxt);
...
static void linkChange(SCDynamicStoreRef store, CFArrayRef changedKeys,  void *info) {
	NetworkLinkSource *src = (NetworkLinkSource *) info;
